...
module.exports = {
  siteMetadata: {
    title: 'Societech', // the default name of the tab
    description: 'Une communauté de passionnés, unis pour répandre la techforgood', // the description of your website
    image: '', // image that appears below the link when sharing
    url: 'https://www.societech.fr', // the url where your site will be
  },
